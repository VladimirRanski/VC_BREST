			...
			<section className='section__games_calendar'>
				<table className="games_calendar">
					...
					<tr className='games_calendar--row'>
						<td className='games_calendar__month' colSpan="5"><span
							className='dateMonth'>Март</span> <span
							className='dateYear'>2023</span></td>
					</tr>
					<tr className='games_calendar--row games_calendar--secondary_row'>
						...
						<td>
							<table className="games_calendar__game">
								...
								<tr>
									<td
										className='games_calendar__team games_calendar__team--host'>«Прибужье»
									</td>
									<td rowSpan="2"><img
										className='games_calendar__team-logo games_calendar__team-logo--host'
										src='./front-end/assets/images/png/logo_pribuzhe.png'/>
									</td>
									<td rowSpan="2" className='games_calendar__game-score'><span
										className='games_calendar__team-score--host games_calendar__team-score--win'>3</span> : <span
										className='games_calendar__team-score--guest'>0</span></td>
									<td rowSpan="2"><img
										className='team__logo team__logo--guest'
										src='./front-end/assets/images/png/logo_pribuzhe.png'/>
									</td>
									<td
										className='games_calendar__team games_calendar__team--guest'>«Коммунальник-Могилев»
									</td>
								</tr>
								<tr>
									<td
										className='games_calendar__team-city games_calendar__team-city--host'>Брест
									</td>
									<td
										className='games_calendar__team-city games-calendar__team-city--guest'>Могилев
									</td>
								</tr>
								</tbody>
							</table>
						...
						<td className='games_calendar__address_game'>
							<div className='games_calendar__address_game--wrapper'>
								<span
									className='games_calendar__address_game--city'>Могилев,</span>
						...
						<td>
							<table className="games_calendar__game">
								...
								<tr>
									...
									<td
										className='games_calendar__team-city games_calendar__team-city--guest'>Могилев
									</td>
								</tr>
								</tbody>
							</table>
